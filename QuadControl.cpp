...
VehicleCommand QuadControl::GenerateMotorCommands(float collThrustCmd, V3F momentCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  // Set the thrust of each propeller to satisfy the collThrustCmd value  
  ...
  // modify the above values to satisfy the required X axis moment. By adding and subtructing the same value to the propellers on the opposite direction I will get the required moment without changing the total thrust
  float xMomentThrustCmd = momentCmd.x/(4.0f*sqrtf(2.0f)*L);  // the X axis thrust of each propeller thrust
  ...
  float yMomentThrustCmd = momentCmd.y / (4.0f * sqrtf(2.0f) * L);  // the Y axis thrust of each propeller thrust
//  torque = kappa * thrust
  ...
  cmd.desiredThrustsN[3] -= yMomentThrustCmd; // rear right
											  ...
											  // modify the above values to satisfy the required X axis moment. By adding and subtructing the same value to the opposite propellers I have the required moment without changing the total thrust
  float zMomentThrustCmd = momentCmd.z / (4.0f * kappa) ;  // the Z axis moment of each propeller thrust
